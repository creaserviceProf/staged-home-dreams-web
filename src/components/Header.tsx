...
const Header = () => {
  ...
  return (
    <header className="w-full">
      ...
      <div className="bg-gray-100 dark:bg-gray-800 py-4 px-4 md:px-10 border-b border-gray-200 dark:border-gray-700">
      ...
      {/* Navigation menu */}
      <div className="bg-white dark:bg-gray-900 py-3 px-4 md:px-10 border-b border-gray-200 dark:border-gray-700">
        <div className="container mx-auto flex justify-between items-center">
          <nav className="hidden md:flex space-x-8">
            <Link to="/" className="uppercase text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400">
              {language === "en" ? "Home" : "Accueil"}
            </Link>
            <Link to="/about" className="uppercase text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400">
              {language === "en" ? "About Us" : "À propos"}
            </Link>
            <Link to="/services" className="uppercase text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400">
              {language === "en" ? "Services" : "Services"}
            </Link>
            <Link to="/portfolio" className="uppercase text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400">
              {language === "en" ? "Portfolio" : "Portfolio"}
            </Link>
            <Link to="/about-staging" className="uppercase text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400">
              {language === "en" ? "About Staging" : "À propos du Staging"}
            </Link>
            <Link to="/contact" className="uppercase text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400">
